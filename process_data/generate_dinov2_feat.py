...
from dino.dino_v2_model import DINOv2

from featurenerf.src.util import set_random_seed
...
patch_h = patch_w = 32
net = DINOv2(patch_h, patch_w).eval()
net = net.to(device)
...
if __name__ == "__main__":
    for synset in synsets:
        ...
        feat_dir = os.path.join(data_root, f"dino_v2_feat_{img_size}", synset)
